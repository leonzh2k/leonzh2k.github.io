(function () {
    ...
    // User Test prompt
    // alert(
    //     "Hello user. Please complete the following tasks: \n 1. Run the code successfully without any errors. \n 2. Try running code on different languages. \n 3. Try a bunch of different inputs."
    // );
    ...
    function switchToJSCode() {
        ...
        `                        <span class="line-number">01</span>   <span class="console">console</span>.<span class="log">log</span>(<span class="string">"First for loop running..."</span>);
                        ...
                        <span id="code-line-3"><label for="unnested-for-loop-max-iter-input"><span class="line-number">03</span>   <span class="for">for</span> (<span class="var-declaration">let</span> <span class="var-name">i</span> = <span class="number">0</span>; <span class="var-name">i</span> &lt; <input id="unnested-for-loop-max-iter-input" title="input type: integer" class="number-input" maxlength="2" autocomplete="off">; <span class="var-name">i</span>++) <span class="for-outer-bracket">{</span></label></span> <span class="comment">// input type: integer (ex. 5)</span>
                        <span id="code-line-4"><label for="unnested-for-loop-console-log-input"><span class="line-number">04</span>       <span class="console">console</span>.<span class="log">log</span>(<input type="text" title="input type: string (ex: &quot;Hello, World!&quot;)" id="unnested-for-loop-console-log-input" maxlength="20" autocomplete="off">);</label></span> <span class="comment">// input type: string (ex. "Hello, World!")</span>
                        ...
                        <span id="code-line-11"><label for="nested-for-loop-outer-loop-max-iter-input"><span class="line-number">11</span>   <span class="for">for</span> (<span class="var-declaration">let</span> <span class="var-name">i</span> = <span class="number">0</span>; <span class="var-name">i</span> &lt; <input id="nested-for-loop-outer-loop-max-iter-input" title="input type: integer" class="number-input" maxlength="2" autocomplete="off">; <span class="var-name">i</span>++) <span class="for-outer-bracket">{</span></label></span> <span class="comment">// input type: integer (ex. 5)</span>
                        ...
                        <span id="code-line-13"><label for="nested-for-loop-inner-loop-max-iter-input"><span class="line-number">13</span>      <span class="for">for</span> (<span class="var-declaration">let</span> <span class="var-name">j</span> = <span class="number">0</span>; <span class="var-name">j</span> &lt; <input id="nested-for-loop-inner-loop-max-iter-input" title="input type: integer" class="number-input" maxlength="2" autocomplete="off">; <span class="var-name">i</span>++) <span class="for-inner-bracket">{</span></label></span> <span class="comment">// input type: integer (ex. 5)</span>
                        <span id="code-line-14"><label for="nested-for-loop-box-symbol"><span class="line-number">14</span>          <span class="var-name">emptyStr</span> += <input type="text" id="nested-for-loop-box-symbol" title="input type: string (ex: &quot;Hello, World!&quot;)" maxlength="3" autocomplete="off">;  </label></span> <span class="comment">// string of length 1</span>
    ...
    function switchToPythonCode() {
        ...
        // has to be indented like this so it shows up indented properly on screen
        codeArea.innerHTML = 
        `                        <span class="line-number">01</span>   <span class="console">print</span>(<span class="string">"First for loop running..."</span>);
                        <span class="line-number">02</span>
                        <span id="code-line-3"><label for="unnested-for-loop-max-iter-input"><span class="line-number">03</span>   <span class="for">for</span> <span class="var-name">i</span> <span class="for">in</span> <span class="range">range</span>(<span class="number">0</span>, <input id="unnested-for-loop-max-iter-input" title="input type: integer" class="number-input" maxlength="2" autocomplete="off">):</label></span> <span class="comment">// input type: integer (ex. 5)</span>
                        <span id="code-line-4"><label for="unnested-for-loop-console-log-input"><span class="line-number">04</span>       <span class="console">print</span>(<input type="text" title="input type: string (ex: &quot;Hello, World!&quot;)" id="unnested-for-loop-console-log-input" maxlength="20" autocomplete="off">)</label></span> <span class="comment">// input type: string (ex. "Hello, World!")</span>
                        <span class="line-number">05</span>   
                        <span class="line-number">06</span>
                        <span class="line-number">07</span>   <span class="console">print</span>(<span class="string">"First for loop ended."</span>)
                        <span class="line-number">08</span>
                        <span class="line-number">09</span>   <span class="console">print</span>(<span class="string">"Nested for loop running..."</span>)
                        <span class="line-number">10</span>
                        <span id="code-line-11"><label for="nested-for-loop-outer-loop-max-iter-input"><span class="line-number">11</span>   <span class="for">for</span> <span class="var-name">i</span> <span class="for">in</span> <span class="range">range</span>(<span class="number">0</span>, <input id="nested-for-loop-outer-loop-max-iter-input" title="input type: integer" class="number-input" maxlength="2" autocomplete="off">): </label></span> <span class="comment">// input type: integer (ex. 5)</span>
                        <span class="line-number">12</span>      <span class="var-name">emptyStr</span> = <span class="string">""</span>;
                        <span id="code-line-13"><label for="nested-for-loop-inner-loop-max-iter-input"><span class="line-number">13</span>      <span class="for">for</span> <span class="var-name">j</span> <span class="for">in</span> <span class="range">range</span>(<span class="number">0</span>, <input id="nested-for-loop-inner-loop-max-iter-input" title="input type: integer" class="number-input" maxlength="2" autocomplete="off">):</label></span> <span class="comment">// input type: integer (ex. 5)</span>
                        <span id="code-line-14"><label for="nested-for-loop-box-symbol"><span class="line-number">14</span>          <span class="var-name">emptyStr</span> += <input type="text" id="nested-for-loop-box-symbol" title="input type: string (ex: &quot;Hello, World!&quot;)" maxlength="3" autocomplete="off">;</label></span> <span class="comment">// string of length 1</span>
                        <span class="line-number">15</span>      
                        <span class="line-number">16</span>      <span class="console">print</span>(<span class="var-name">emptyStr</span>);
                        <span class="line-number">17</span>   
                        <span class="line-number">18</span>
                        <span class="line-number">19</span>  <span class="console">print</span>(<span class="string">"Nested for loop ended."</span>);
                        <span class="line-number">20</span>
                        <span class="line-number">21</span>
                        <span class="line-number">22</span>
                        <span class="line-number">23</span>
    ...
    function switchToCCode() {
        let codeArea = document.querySelector("#code-input pre");
        // has to be indented like this so it shows up indented properly on screen
        codeArea.innerHTML = 
        `                        <span class="line-number">01</span>   <span class="console">printf</span>(<span class="string">"First for loop running...\\n"</span>);
                        <span class="line-number">02</span>
                        <span id="code-line-3"><label for="unnested-for-loop-max-iter-input"><span class="line-number">03</span>   <span class="for">for</span> (<span class="var-declaration">int</span> <span class="var-name">i</span> = <span class="number">0</span>; <span class="var-name">i</span> &lt; <input id="unnested-for-loop-max-iter-input" title="input type: integer" class="number-input" maxlength="2" autocomplete="off">; <span class="var-name">i</span>++) <span class="for-outer-bracket">{</span></label></span> <span class="comment">// input type: integer (ex. 5)</span>
                        <span id="code-line-4"><label for="unnested-for-loop-console-log-input"><span class="line-number">04</span>       <span class="console">printf</span>(<input type="text" title="input type: string (ex: &quot;Hello, World!&quot;)" id="unnested-for-loop-console-log-input" maxlength="20" autocomplete="off">);</label></span> <span class="comment">// input type: string (ex. "Hello, World!")</span>
                        <span class="line-number">05</span>   <span class="for-outer-bracket">}</span>
                        <span class="line-number">06</span>
                        <span class="line-number">07</span>   <span class="console">printf</span>(<span class="string">"First for loop ended.\\n"</span>);
                        <span class="line-number">08</span>
                        <span class="line-number">09</span>   <span class="console">printf</span>(<span class="string">"Nested for loop running...\\n"</span>);
                        <span class="line-number">10</span>
                        <span id="code-line-11"><label for="nested-for-loop-outer-loop-max-iter-input"><span class="line-number">11</span>   <span class="for">for</span> (<span class="var-declaration">let</span> <span class="var-name">i</span> = <span class="number">0</span>; <span class="var-name">i</span> &lt; <input id="nested-for-loop-outer-loop-max-iter-input" title="input type: integer" class="number-input" maxlength="2" autocomplete="off">; <span class="var-name">i</span>++) <span class="for-outer-bracket">{</span></label></span> <span class="comment">// input type: integer (ex. 5)</span>
                        <span class="line-number">12</span>      
                        <span id="code-line-13"><label for="nested-for-loop-inner-loop-max-iter-input"><span class="line-number">13</span>      <span class="for">for</span> (<span class="var-declaration">let</span> <span class="var-name">j</span> = <span class="number">0</span>; <span class="var-name">j</span> &lt; <input id="nested-for-loop-inner-loop-max-iter-input" title="input type: integer" class="number-input" maxlength="2" autocomplete="off">; <span class="var-name">i</span>++) <span class="for-inner-bracket">{</span></label></span> <span class="comment">// input type: integer (ex. 5)</span>
                        <span id="code-line-14"><label for="nested-for-loop-box-symbol"><span class="line-number">14</span>          <span class="console">printf</span>(<input type="text" id="nested-for-loop-box-symbol" title="input type: string (ex: &quot;Hello, World!&quot;)" maxlength="3" autocomplete="off">);</label></span> <span class="comment">// string of length 1</span>
                        <span class="line-number">15</span>      <span class="for-inner-bracket">}</span>
                        <span class="line-number">16</span>      <span class="console">printf</span>(<span class="string">"\\n"</span>);
                        <span class="line-number">17</span>   <span class="for-outer-bracket">}</span>
                        <span class="line-number">18</span>
                        <span class="line-number">19</span>  <span class="console">printf</span>(<span class="string">"Nested for loop ended.\\n"</span>);
                        <span class="line-number">20</span>
                        <span class="line-number">21</span>
                        <span class="line-number">22</span>
                        <span class="line-number">23</span>
    ...
    // switchToCCode(); //force to one Language for easy testing (remove this later)
